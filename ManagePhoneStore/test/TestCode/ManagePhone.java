    ...
    void fillTable() {
        ...
        try {
            try {
                ...
                Dialog.MessageError(this, "Unable to query data! // " + e);
            }
...
//            txtPhoneCode.enable(false);
    ...
    public void viewPhoneDetail(String codephone) {
        ...
        try {
            ...
            Dialog.MessageError(this, "Không tìm thấy sản phẩm");
        }
    }
    ...
    private void initComponents() {
        ...
        tabTableLayout.setVerticalGroup(
            ...
            .addGroup(tabTableLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(truot1, javax.swing.GroupLayout.PREFERRED_SIZE, 446, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(37, 37, 37)
                .addGroup(tabTableLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnLeftEnd)
                    .addComponent(btnLeft)
